            ...
            <div class="more-detail" v-if="showDescription">
                <div class="description">
                    ...
                    <p>
                        ...
                        <br/><br/>
                        In the generation of information explosion, not only the information we receive, 
                        but also our personal data is being uploaded to the internet unconsciously. In the future, 
                        the one who has the most information will be the overlord.
                        <br/><br/>
                        In the work "digital footprint", Hsiao Li-Chi visualises the internet as a small space. 
                        Everything that has happened in this space will be played out and then a hash code will 
                        be printed as proof of the event’s existence. It will play only once. The audience has to watch out to memorise it, 
                        if they miss it, it will become just a digital footprint.
                        <br/><br/>
