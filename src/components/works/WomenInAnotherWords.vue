			...
			<div v-if="showDescription" class="more-detail">
				<div class="description">
					...
					<p>
						...
						<br />A word to describe your best condition. <br />I put this conception in
						our audio-visual project. People can test their skin condition and create
						threir own moving image. They can either download through app or recieve by
						E-mail",
					</p>
				</div>
				<div class="gallery">
...
export default {
	...
	data() {
		return {
			...worksJson[worksJson.map(e => e.id).indexOf('201803')],
